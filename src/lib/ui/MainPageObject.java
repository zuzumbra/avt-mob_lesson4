...
/*    public WebElement waitForElementAndSendKeys(String locator, String value, String error_massege, long timeoutInSeconds)
    {
        WebElement element = waitForElementPresent(locator, error_massege, timeoutInSeconds);
    ...
    public void clickElementToTheRightUpperCorner(String locator, String error_message)
    {
        ...
        TouchAction action = new TouchAction(driver);
        action.tap(point_to_click_x, middle_y).perform();
    }
